(function() {
  ...
  define(function() {
    ...
    Logger = (function() {
      ...
      Logger.prototype.consoleEnabled = (typeof console != "undefined" && console !== null ? console.log : void 0) != null;
      Logger.prototype.log = function(logLevel, message) {
        if ((this.loggable(logLevel) != null) && (typeof consoleEnabled != "undefined" && consoleEnabled !== null)) {
