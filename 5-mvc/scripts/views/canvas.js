(function() {
  ...
  define(['jquery', 'constants', 'logging'], function($, constants, log) {
    var DragState, MouseDraggedEvent, MouseEvent, canvas, captureRedraw, components, context, deviceCoordinateX, deviceCoordinateY, dragState, fire, logging, mouseDown, mouseDownListeners, mouseDragEndListeners, mouseDragListeners, mouseMove, mouseMoveListeners, mouseOut, mouseUp, mouseUpListeners;
    canvas = $('#canvas')[0];
