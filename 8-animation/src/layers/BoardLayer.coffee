define ['log', 'jquery', 'math', 'constants', 'ui/Layer', 'layers/DudeLayer', 'layers/HexagonLayer', 'layers/CharacterLayer'], (log, $, math, constants, Layer, DudeLayer, HexagonLayer, CharacterLayer) ->
  class BoardLayer extends Layer
    constructor: (@game) ->
      ...
      $("#add_dude").click =>
        @dudes = @dudes or 0
        @dudes++
        $("#add_dude").attr('value', "Add Dude #{@dudes + 1}")
        new DudeLayer(this, @dudes, @hexagons)
