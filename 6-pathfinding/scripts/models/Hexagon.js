(function() {
  ...
  define(["constants", "logging"], function(constants, log) {
    ...
    return Hexagon = (function() {
      ...
      Hexagon.prototype.addHighlightListener = function(fn) {
        return this.highlightListeners.push(fn);
      };
      ...
      Hexagon.prototype.highlight = function(value) {
        if (value !== this.highlighted) {
          this.highlighted = value;
          return this.fire(this.highlightListeners, this);
        }
      };
      ...
      Hexagon.prototype.toString = function() {
        return "Hexagon(x: " + this.x + ", y: " + this.y + ", highlighted: " + this.highlighted + ", selected: " + this.selected + ")";
      };
      return Hexagon;
    })();
  });
